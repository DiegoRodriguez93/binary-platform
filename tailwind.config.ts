  ...
  theme: {
    extend: {
      colors: {
        ...
        // Custom color palette for the binary trading theme
        primary: {
          50: '#faf5ff',
          100: '#f3e8ff',
          200: '#e9d5ff',
      ...
      boxShadow: {
        ...
        'glass-lg': '0 20px 60px rgba(31, 38, 135, 0.37)',
      },
      backdropBlur: {
        'xs': '2px',
      },
      backgroundImage: {
        ...
        'gradient-mesh': 'linear-gradient(135deg, rgba(168, 85, 247, 0.1) 0%, rgba(236, 72, 153, 0.1) 50%, rgba(14, 165, 233, 0.1) 100%)',
        'hero-gradient': 'linear-gradient(135deg, #0f172a 0%, #581c87 35%, #0f172a 100%)',
