...
import { ChevronDown, Search, TrendingUp, TrendingDown, Activity } from 'lucide-react';
import { PriceDataV2 } from './TradeV2';

interface SymbolSelectorV2Props {
...
const symbols: Symbol[] = [
    // Forex
    { value: 'EURUSD', label: 'EUR/USD', flag: '🇪🇺🇺🇸', category: 'forex', description: 'Euro vs US Dollar', spread: 0.8, leverage: 500 },
    { value: 'GBPUSD', label: 'GBP/USD', flag: '🇬🇧🇺🇸', category: 'forex', description: 'British Pound vs US Dollar', spread: 1.2, leverage: 500 },
    { value: 'USDJPY', label: 'USD/JPY', flag: '🇺🇸🇯🇵', category: 'forex', description: 'US Dollar vs Japanese Yen', spread: 0.9, leverage: 500 },
    { value: 'AUDUSD', label: 'AUD/USD', flag: '🇦🇺🇺🇸', category: 'forex', description: 'Australian Dollar vs US Dollar', spread: 1.1, leverage: 500 },
    { value: 'USDCAD', label: 'USD/CAD', flag: '🇺🇸🇨🇦', category: 'forex', description: 'US Dollar vs Canadian Dollar', spread: 1.3, leverage: 500 },
    { value: 'EURGBP', label: 'EUR/GBP', flag: '🇪🇺🇬🇧', category: 'forex', description: 'Euro vs British Pound', spread: 1.5, leverage: 500 },

    // Stocks
    { value: 'AAPL', label: 'AAPL', flag: '🍎', category: 'stocks', description: 'Apple Inc.', spread: 0.02, leverage: 20 },
    { value: 'GOOGL', label: 'GOOGL', flag: '🔍', category: 'stocks', description: 'Alphabet Inc.', spread: 0.05, leverage: 20 },
    { value: 'MSFT', label: 'MSFT', flag: '🪟', category: 'stocks', description: 'Microsoft Corporation', spread: 0.03, leverage: 20 },
    { value: 'TSLA', label: 'TSLA', flag: '🚗', category: 'stocks', description: 'Tesla Inc.', spread: 0.08, leverage: 10 },
    { value: 'NVDA', label: 'NVDA', flag: '🎮', category: 'stocks', description: 'NVIDIA Corporation', spread: 0.12, leverage: 10 },
    { value: 'AMZN', label: 'AMZN', flag: '📦', category: 'stocks', description: 'Amazon.com Inc.', spread: 0.06, leverage: 20 },

    // Crypto
    { value: 'BTCUSD', label: 'BTC/USD', flag: '₿', category: 'crypto', description: 'Bitcoin vs US Dollar', spread: 15.0, leverage: 100 },
    { value: 'ETHUSD', label: 'ETH/USD', flag: '⟠', category: 'crypto', description: 'Ethereum vs US Dollar', spread: 2.5, leverage: 100 },
    { value: 'ADAUSD', label: 'ADA/USD', flag: '🔷', category: 'crypto', description: 'Cardano vs US Dollar', spread: 0.002, leverage: 50 },
    { value: 'SOLUSD', label: 'SOL/USD', flag: '☀️', category: 'crypto', description: 'Solana vs US Dollar', spread: 0.15, leverage: 50 },
    { value: 'DOTUSD', label: 'DOT/USD', flag: '🔴', category: 'crypto', description: 'Polkadot vs US Dollar', spread: 0.08, leverage: 50 },

    // Commodities
    { value: 'XAUUSD', label: 'XAU/USD', flag: '🥇', category: 'commodities', description: 'Gold vs US Dollar', spread: 0.35, leverage: 100 },
    { value: 'XAGUSD', label: 'XAG/USD', flag: '🥈', category: 'commodities', description: 'Silver vs US Dollar', spread: 0.03, leverage: 100 },
    { value: 'WTIUSD', label: 'WTI/USD', flag: '🛢️', category: 'commodities', description: 'West Texas Intermediate Oil', spread: 0.05, leverage: 100 },
    { value: 'BRENTUSD', label: 'Brent/USD', flag: '⚫', category: 'commodities', description: 'Brent Crude Oil', spread: 0.05, leverage: 100 },
    { value: 'GASUSD', label: 'Gas/USD', flag: '⛽', category: 'commodities', description: 'Natural Gas', spread: 0.02, leverage: 100 },
];
...
const SymbolSelectorV2: React.FC<SymbolSelectorV2Props> = React.memo(({
    selectedSymbol,
    onSymbolChange,
    currentPrice,
    marketTrend,
                    ...
                    >
                        <span className="flex items-center gap-4">
                            ...
                            <div className="text-left">
                                <div className="font-bold text-xl">{selectedSymbolData?.label}</div>
                                <div className="text-sm text-gray-400 font-normal">{selectedSymbolData?.description}</div>
                                <div className="text-xs text-gray-500 mt-1">
                                    Spread: {selectedSymbolData?.spread} | Leverage: 1:{selectedSymbolData?.leverage}
                                </div>
                            </div>
                        </span>
...
SymbolSelectorV2.displayName = 'SymbolSelectorV2';

export default SymbolSelectorV2;